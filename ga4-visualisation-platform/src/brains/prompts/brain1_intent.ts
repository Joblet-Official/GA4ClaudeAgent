...
Output:
{"report_type":"weekly_summary","sub_questions":[{"id":"q1","natural_language":"weekly sessions by region","kind":"primary"},{"id":"q2","natural_language":"weekly applies by region","kind":"primary"}],"scope":{"dateRange":{"start":"<computed 6 weeks ago>","end":"<today>"},"regions":[],"filters_hint":[]},"is_followup":false,"ambiguity_flags":["region groupings not specified"]}

User: "how many sessions did we get yesterday"
Output:
{"report_type":"single_metric","sub_questions":[{"id":"q1","natural_language":"total sessions yesterday","kind":"primary"}],"scope":{"dateRange":{"start":"<yesterday>","end":"<yesterday>"},"regions":null,"filters_hint":[]},"is_followup":false,"ambiguity_flags":[]}
...
Output:
{"report_type":"regional_breakdown","sub_questions":[{"id":"q1","natural_language":"prior weekly summary broken down by country","kind":"primary"}],"scope":{"dateRange":"last_30_days","regions":[],"filters_hint":[]},"is_followup":true,"ambiguity_flags":[]}
